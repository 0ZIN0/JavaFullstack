...
public class C08_Extend {
	...
	/*
	 	...
	 	연습 문제: myobj 패키지에 상속 관계에 있는 클래스들을 정의해보세요
	*/
	...
	public static void main(String[] args) {
		...
		Gun g1 = new Gun(3, 5, 20);
		
		g1.reload();
		
		System.out.println(g1.bullet);
...
class Coffee {
	...
	void drink() {
		System.out.println("커피를 마서셔 " + this.shot + "만큼 잠이  깼습니다");
	}
...
class Americano extends Coffee {
	...
	// 부모 클래스에 기본 생성자가 존재하는 경우 super()를 생성할 수 있지만
	// 기본 생성자가 존재하지 않는 경우에는 생략이 불가능하다
	public Americano() {
		super(2, 1500, "아메리카노");
	}
	...
	// 메서드가 오버라이드 되었어더라도 부모 클래스의 메서드를 불러다 사용하는 것이 가능하다
	void superDrink() {
		super.drink();
	}
