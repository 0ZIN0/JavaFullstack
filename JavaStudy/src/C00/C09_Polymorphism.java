...
//		Americano a1 = new Coffee(1, 2, " abc");
		...
		// 가능한 다운 캐스팅 
		// (원래 아메리카노 인스턴스는 다시 아메리카노 인스턴스가 될 수 있다)
		Americano a2 = (Americano) c1;
		
		c2.drink();
		a2.putWater(333);
		a2.putWater(50);
		System.out.println(a2.water);
		
		System.out.println();
		a2.check();
		
		// 불가능한 다운 캐스팅
		// 원래 커피였던 인스턴스를 아메리카노로 다운 캐스팅 하는 것은 가능하지만
		// 에러가 발생한다 - class Coffe cannot be cast to class Americano
