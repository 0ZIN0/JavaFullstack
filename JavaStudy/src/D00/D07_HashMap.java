...
public class D07_HashMap {
	...
	public static void main(String[] args) {
		...
		p1.put("name", "홍길동");
 		...
 		navigation.put("맛집", "무슨북도 무슨리 무슨읍 ...");
 		...
 		// 게임 기록을 저장할 때 최초 기록이라면 데이터를 0으로 초기화 하고
 		// 이미 점수가 있다면 꺼내주는 역할
 		HashMap<String, Integer> scoreboard = new HashMap<>();
 		
 		scoreboard.put("김찬우", 880);
 		System.out.println(scoreboard.putIfAbsent("김찬우", 0));
 		...
 		System.out.println(scoreboard.containsKey("김찬우"));
 		...
 		System.out.println(scoreboard.remove("김찬우"));
