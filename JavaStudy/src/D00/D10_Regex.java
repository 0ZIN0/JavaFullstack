...
public class D10_Regex {
	...
	public static void main(String[] args) {
		...
		System.out.println(Pattern.matches("[cs][lh\\\\]eep", "c\\eep"));
		...
		System.out.println(Pattern.matches("[0-9]at", "3at"));
		System.out.println(Pattern.matches("[a-e&&c-y]at", "dat"));
		...
		System.out.println(Pattern.matches("\\dat", "8at"));
		System.out.println(Pattern.matches("\\Dat", "cat"));
		...
		// 여러개 중 하나를 선택하게 만들기
		System.out.println("test2 : " + Pattern.matches("255|168|123", "255"));
		
		// 연습1: 해당 문자열이 핸드폰 번호인지 검사할 수 있는 정규 표현식을 만들어보세요
		//		 (옛날 번호 포함)
		System.out.println(Pattern.matches("01[01679](-\\d{3,4}-||\\d{3,4})\\d{4}", 
				"010-234-3434"));
		
		// 연습2 : 해당 문자열이 이메일인지 검사할 수 있는 정규표현식을 만들어보세요
		System.out.println(Pattern.matches("\\w+@\\w+[.](\\w+[.])?\\w+",
				"asdsdsa@hanmail.com"));
		...
		System.out.println(Pattern.matches(regex3, "255.255.255.255"));
		...
		String fruits = "apple/banana/kiwi/pineapple/mango/kiwi/orange"
				...
				+ "/redkiwi+/redkiwi+/redkiwi/redkiwi/redkiwi";
		...
		while (m1.find()) {
			System.out.println("찾은 것 : " + m1.group(0));  
			System.out.println("시작 위치 : " + m1.start(0));
			System.out.println("끝 위치 : " + m1.end(0));
		}
