...
public class D01_ArrayList {
	...
	public static void main(String[] args) {
		...
		// list.add(item) : 해당 리스트의 맨 뒤에 데이터를 추가하는 메서드
		list1.add("apple"); 
		list1.add("kiwi");
		list1.add("mango");
		list1.add("딸기");
		...
		// remove(item) : 해당 값을 지닌 요소를 지운다
		String removed = countries.remove(5);
		System.out.println("지원진 것 : " + removed);
		System.out.println(countries);
		...
		/*
		 	# Java Collection Interface
		 	  ...
		 	  Collection은 언제든지 다른 컬렉션으로 쉽게 변환이 가능하다
		...
		// 값을 전달해 해당 값을 지울때는 삭제 성공여부가 반환
		boolean delete = countries.remove("Afganistan");
