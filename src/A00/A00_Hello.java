...
/**
	파란 여러 줄 주석
	- 메서드나 클래스에 대한 설명을 적을 때 사용
 */
/* 워크스페이스 내부 > 프로젝트 폴더 내부 > src 폴더 내부에 소스코드(.java)를 작성한다
 * Ctrl + F11을 눌렀을때
 * 컴파일 결과물(.class)는 프로젝트 폴더 내부의 bin 폴더에 보관되며
...
public class A00_Hello {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	4. 소수를 적는 것   : 실수(Flat, Double), 계산 가능
		...
		System.out.println(true);
		System.out.println("가격 : " + 9800 + "원");
		System.out.println("가격 : " + 4000 + 4500 + "원");
		//ㄴ 결과는 문자열 타입
		System.out.println("가격 : " + (4000 + 4500) + "원");
		System.out.println("안경을 썻는가? " + true);
		System.out.println("밥값을 계산 하였는가? " + false);
		//프로그램의 끝
	}
