...
public class E08_File {
	...
	/*
	 	# java.io.File
	 	  ...
	 	  인스턴스를 생성할때 실제 파일로부터 정보를 받아온다
	 	  해당 인스턴스에 담긴 정보를 통해 파일 시스템을 직접 제어할 수 있다
	 	  
	 	# 파일시스템
	 	
	 	  하드디스크에 저장된 데이터들을 손쉽게 관리할 수 있도록 설정한 일부 구역
	...
	public static void main(String[] args) {
		...
		File f3 = new File("C:/javafullstack_evening_kcw/java-workspace/");
		File f4 = new File("./files/tes.txt");
		...
		// isAbsolute() : 해당 경로가 절대 경로인지 여부를 검사
