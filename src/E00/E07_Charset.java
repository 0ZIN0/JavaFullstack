...
public class E07_Charset {
	...
	/*
	 	# Charset
	 	  ...
	 	  ASCII 코드 까지는 모든 Charset이 동일하지만 그 이후부터는 각 회사마다
	 	  다른 문자코드를 사용한다
	 	  MS949  : 윈도우즈에서 사용하는 마이크로소프트의 문자셋
	 	  EUC-KR : 이클립스가 기본적으로 사용하는 문자셋 (유효한 한국어만 사용, 뛿뛻 x)
	...
	public static void main(String[] args) {
		...
		try(FileWriter out = 
				new FileWriter("files/encodingTest.txt", 
		...
		try(FileReader in = 
				new FileReader("files/encodingTest.txt", Charset.forName("EUC-KR"));
		) {
